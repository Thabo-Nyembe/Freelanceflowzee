...
// Batch 19: More specialized v1 pages we may have missed
const pages = [
  '/v1/dashboard/admin-overview',
  '/v1/dashboard/allocation',
  '/v1/dashboard/audio',
  '/v1/dashboard/business-model',
  '/v1/dashboard/canvas',
  '/v1/dashboard/channels',
  '/v1/dashboard/client-portal',
  '/v1/dashboard/client-zone',
  '/v1/dashboard/commerce',
  '/v1/dashboard/competitive',
  '/v1/dashboard/content',
  '/v1/dashboard/deposits',
];

const baseUrl = 'http://localhost:9323';
const screenshotsDir = '/tmp/kazi-batch19';
