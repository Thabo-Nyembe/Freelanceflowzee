...
// Batch 17: Subpages - client-zone and bookings
const pages = [
  '/v1/dashboard/client-zone/projects',
  '/v1/dashboard/client-zone/invoices',
  '/v1/dashboard/client-zone/messages',
  '/v1/dashboard/client-zone/files',
  '/v1/dashboard/client-zone/calendar',
  '/v1/dashboard/bookings/calendar',
  '/v1/dashboard/bookings/services',
  '/v1/dashboard/bookings/clients',
  '/v1/dashboard/financial/invoices',
  '/v1/dashboard/financial/transactions',
  '/v1/dashboard/collaboration/workspace',
  '/v1/dashboard/collaboration/teams',
];

const baseUrl = 'http://localhost:9323';
const screenshotsDir = '/tmp/kazi-batch17';
