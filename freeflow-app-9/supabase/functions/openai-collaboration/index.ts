...
async function generateProjectInsights(openai: OpenAI, projectData: any) {
...
async function smartCategorization(openai: OpenAI, data: any) {
...
async function generateClientReport(openai: OpenAI, reportData: any) {
...
// Helper functions
function estimateRevisionTime(comments: any[]): string {
...
function categorizeFeedback(comments: any[]) {
  return {
