-- ============================================================================
-- STORAGE MANAGEMENT SYSTEM - FIX MIGRATION
-- Handles existing tables by altering them instead of recreating
-- ============================================================================
...
-- ============================================================================
-- TABLE: storage_files (create after folders)
-- ============================================================================
...
CREATE INDEX idx_storage_shares_folder_id ON storage_shares(folder_id);
CREATE INDEX idx_storage_shares_user_id ON storage_shares(user_id);
