-- =====================================================
-- FIX ENGAGEMENT TABLES - Drop and recreate with proper schema
-- Run this in Supabase Dashboard > SQL Editor
-- =====================================================

-- Drop existing tables (in reverse dependency order)
DROP TABLE IF EXISTS user_milestones CASCADE;
DROP TABLE IF EXISTS engagement_recommendations CASCADE;
...
CREATE INDEX idx_activity_user_timestamp ON user_activity_log(user_id, timestamp DESC);
...
CREATE INDEX idx_recommendations_user_status ON engagement_recommendations(user_id, status);
