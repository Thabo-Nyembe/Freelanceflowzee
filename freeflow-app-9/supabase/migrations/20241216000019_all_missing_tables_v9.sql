...
CREATE TABLE IF NOT EXISTS activity_logs (
  ...
  -- Activity details
  TEXT VARCHAR(50) NOT NULL DEFAULT 'view',
...
CREATE TABLE IF NOT EXISTS api_endpoints (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  endpoint_code VARCHAR(20) UNIQUE DEFAULT ('END-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE IF NOT EXISTS backups (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  backup_code VARCHAR(20) UNIQUE DEFAULT ('BKP-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE IF NOT EXISTS email_agent_responses (
  ...
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  type TEXT NOT NULL DEFAULT 'ai-generated',
  subject TEXT NOT NULL,
  body TEXT NOT NULL,
  sent_at TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS help_articles (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  article_code VARCHAR(20) UNIQUE DEFAULT ('ART-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE IF NOT EXISTS lead_activities (
  ...
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  TEXT VARCHAR(50) NOT NULL CHECK (TEXT IN ('email', 'call', 'meeting', 'note', 'status_change', 'score_change')),
  title VARCHAR(255) NOT NULL,
  description TEXT,
  metadata JSONB DEFAULT '{}',
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
...
CREATE TABLE IF NOT EXISTS maintenance_windows (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  window_code VARCHAR(20) UNIQUE DEFAULT ('MNT-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE IF NOT EXISTS performance_benchmarks (
  ...
  benchmark_level TEXT NOT NULL DEFAULT 'average',
...
CREATE TABLE IF NOT EXISTS shipments (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  shipment_code VARCHAR(20) UNIQUE DEFAULT ('SHP-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE IF NOT EXISTS social_posts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  post_code TEXT NOT NULL DEFAULT ('SOC-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
  content TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS store_apps (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  app_code VARCHAR(20) UNIQUE DEFAULT ('APP-' || SUBSTRING(gen_random_uuid()::text, 1, 8)),
