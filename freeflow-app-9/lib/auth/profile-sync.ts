/**
 * OAuth Profile Sync Utility
 * Automatically syncs user profile data from OAuth providers
 */
...
/**
 * Sync OAuth profile to Supabase database
 */
export async function syncOAuthProfile(userId: string, profile: Partial<UserProfile>) {
 ...
 */
export async function mergeOAuthProfile(
  userId: string,
