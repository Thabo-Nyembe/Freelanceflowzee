...
export const WEBHOOKS: Webhook[] = [
  {
    ...
    status: 'active',
    secret: 'whsec_MOCK_SLACK_SECRET_REPLACE_ME',
  ...
  },
  {
    ...
    status: 'active',
    secret: 'whsec_MOCK_CRM_SECRET_REPLACE_ME',
  ...
  },
  {
    ...
    status: 'active',
    secret: 'whsec_MOCK_ANALYTICS_SECRET_REPLACE_ME',
  ...
  },
  {
    ...
    status: 'active',
    secret: 'whsec_MOCK_PAYMENT_SECRET_REPLACE_ME',
