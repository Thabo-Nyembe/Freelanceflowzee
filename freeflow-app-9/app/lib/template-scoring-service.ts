...
export class TemplateAnalysisService {
  calculateTemplateScore(template: CanvasObject): TemplateAnalysis {
    // Base scores
  ...
  private calculateTechnicalScore(template: CanvasObject): number {
  ...
  private calculateCreativityScore(template: CanvasObject): number {
  ...
  private calculateMarketScore(template: CanvasObject): number {
