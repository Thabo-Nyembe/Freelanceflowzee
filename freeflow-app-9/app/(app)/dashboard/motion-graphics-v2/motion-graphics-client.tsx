...
export default function MotionGraphicsClient({
  ...
  return (
    <div className="bg-gradient-to-br from-cyan-50 via-blue-50/30 to-indigo-50/40 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 dark:bg-none dark:bg-gray-900 p-6 rounded-xl overflow-hidden">
