      ...
      <div className="max-w-[1800px] mx-auto space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="performance" className="mt-6 space-y-6">
            ...
            <Card className="border-gray-200 dark:border-gray-700">
              <CardHeader className="flex flex-row items-center justify-between"><CardTitle>Recent Reviews</CardTitle><Button onClick={() => setShowReviewDialog(true)}><Plus className="h-4 w-4 mr-2" />Start Review</Button></CardHeader>
          ...
          <TabsContent value="settings" className="mt-6">
            <div className="grid grid-cols-2 gap-6">
              ...
              <Card className="border-gray-200 dark:border-gray-700">
                <CardHeader><CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5" />Privacy & Access</CardTitle></CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between"><div><p className="font-medium">Salary Visibility</p><p className="text-sm text-gray-500">Who can view compensation data</p></div><Select defaultValue="managers"><SelectTrigger className="w-32"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="all">Everyone</SelectItem><SelectItem value="managers">Managers</SelectItem><SelectItem value="hr">HR Only</SelectItem></SelectContent></Select></div>
                  <div className="flex items-center justify-between"><div><p className="font-medium">Performance Data</p><p className="text-sm text-gray-500">Review visibility settings</p></div><Select defaultValue="managers"><SelectTrigger className="w-32"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="all">Everyone</SelectItem><SelectItem value="managers">Managers</SelectItem><SelectItem value="hr">HR Only</SelectItem></SelectContent></Select></div>
