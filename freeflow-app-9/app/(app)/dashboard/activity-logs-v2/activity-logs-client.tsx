...
export default function ActivityLogsClient({ initialLogs }: ActivityLogsClientProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/40 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 dark:bg-none dark:bg-gray-900 rounded-xl overflow-hidden">
      {/* Premium Header */}
