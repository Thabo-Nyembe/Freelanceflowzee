                          ...
                          <div className="opacity-0 group-hover:opacity-100 flex items-start gap-1">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => toast.success('Reminder set', { description: 'We will remind you about this message in 1 hour' })}><Bell className="h-4 w-4 mr-2" />Remind Me</DropdownMenuItem>
                                <DropdownMenuSeparator />
