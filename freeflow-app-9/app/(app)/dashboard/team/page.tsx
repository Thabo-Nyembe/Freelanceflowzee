...
import { Users, Plus, Mail, Phone, MoreHorizontal, Shield, Crown, User } from 'lucide-react'
        ...
        <CardContent>
          <div className="space-y-4">
            {teamMembers.map((member) => (
              <div key={member.id} className="flex items-center justify-between p-4 border rounded-lg hover:shadow-sm transition-all">
