          ...
          <TabsContent value="settings">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-3">
                  {mockWorkingHours.map(wh => (
                    <div key={wh.day} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      ...
                      {wh.enabled ? (
                        <div className="flex items-center gap-2 flex-1">
                          <Input type="time" defaultValue={wh.start} className="w-28 h-8" />
                          <span className="text-gray-400">to</span>
                          <Input type="time" defaultValue={wh.end} className="w-28 h-8" />
                        </div>
                      ) : (
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {[
                    { name: 'Google Calendar', connected: true, email: 'user@gmail.com' },
                    { name: 'Outlook', connected: true, email: 'user@outlook.com' },
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Show Secondary Time Zone</p>
