...
export default function RegistrationsClient() {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 via-indigo-50/30 to-blue-50/40 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 dark:bg-none dark:bg-gray-900 rounded-xl overflow-hidden">
      {/* Header */}
