...
export default function DependenciesClient({ initialDependencies }: { initialDependencies: Dependency[] }) {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 via-purple-50/30 to-pink-50/40 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 dark:bg-none dark:bg-gray-900 rounded-xl overflow-hidden">
      {/* Premium Header */}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button variant="outline" onClick={() => toast.success('Webhook test sent')}>Test</Button>
                          </div>
                        </div>
                      </div>
                    </div>
