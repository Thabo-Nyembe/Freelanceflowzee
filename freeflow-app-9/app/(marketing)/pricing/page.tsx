...
export default function PricingPage() {
  return (
    <>
      <Head>
        <title>Pricing - FreeflowZee</title>
        <meta name="description" content="Choose the perfect plan for your creative business. From free file sharing to premium AI tools and escrow payments." />
        <meta name="keywords" content="pricing plans, creative business tools, AI features, file sharing, escrow payments" />
        <meta property="og:title" content="Pricing - FreeflowZee" />
        <meta property="og:description" content="Choose the perfect plan for your creative business. From free file sharing to premium AI tools and escrow payments." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://freeflowzee.com/pricing" />
