    ...
    <div className="min-h-screen relative bg-slate-950">
      ...
      <div className="max-w-4xl mx-auto p-6 relative">
        ...
        <div className="relative">
          <GlowEffect className="absolute -inset-1 bg-gradient-to-r from-green-500/30 to-emerald-500/30 rounded-2xl blur opacity-40" />
            ...
            <CardContent className="prose max-w-none">
              ...
              <section className="space-y-4 mt-8">
                ...
                <ul className="list-none space-y-1 text-gray-300">
                  ...
                  <li>Website: <Link href="/contact" className="text-green-400 hover:underline">Contact Form</Link></li>
                </ul>
              </section>
            </CardContent>
          </LiquidGlassCard>
