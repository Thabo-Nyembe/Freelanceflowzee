    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-800">
      ...
      <div className="flex h-[calc(100vh-88px)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <AIInsightsPanel insights={canvasCollaborationAIInsights} />
          <PredictiveAnalytics predictions={canvasCollaborationPredictions} />
          <CollaborationIndicator collaborators={canvasCollaborationCollaborators} />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <QuickActionsToolbar actions={canvasCollaborationQuickActions} />
          <ActivityFeed activities={canvasCollaborationActivities} />
        </div>
<div className="flex items-center justify-between">
