...
export default function CvPortfolioClient() {
  ...
  const confirmAddProject = () => {
    ...
    toast.success('Project Added! Project added to portfolio (CV ' + newCompleteness + '% complete)')
  }
  ...
  const handleMoveSectionUp = (sectionId: string) => {
    ...
    toast.success("Section Reordered! moved up")
  }
  ...
  const handleMoveSectionDown = (sectionId: string) => {
    ...
    setCvSections(newSections)
    toast.success("Section Reordered! moved down")
  }
  ...
  const handleToggleVisibility = (type: 'projects' | 'skills' | 'experience' | 'education') => {
    ...
    toast.success("Section Updated! is now " + (newVisibility ? "visible" : "hidden") + " on your CV")
    ...
    return (
      <div className="min-h-screen kazi-bg-light dark:kazi-bg-dark p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <AIInsightsPanel insights={cvPortfolioAIInsights} />
          <PredictiveAnalytics predictions={cvPortfolioPredictions} />
          <CollaborationIndicator collaborators={cvPortfolioCollaborators} />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <QuickActionsToolbar actions={cvPortfolioQuickActions} />
          <ActivityFeed activities={cvPortfolioActivities} />
        </div>
