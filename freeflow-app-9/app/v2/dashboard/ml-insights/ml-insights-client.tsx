    ...
    return (
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <AIInsightsPanel insights={mlInsightsAIInsights} />
          <PredictiveAnalytics predictions={mlInsightsPredictions} />
          <CollaborationIndicator collaborators={mlInsightsCollaborators} />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <QuickActionsToolbar actions={mlInsightsQuickActions} />
          <ActivityFeed activities={mlInsightsActivities} />
        </div>
