...
import { useApiKeys, getKeyTypeColor } from '@/lib/hooks/use-api-keys'
...
const mockWebhooks: WebhookEndpoint[] = [
  {
    ...
    secret: 'whsec_MOCK_REPLACE_WITH_REAL_SECRET_1',
    status: 'active',
    version: 'v2',
  ...
  },
  {
    ...
    secret: 'whsec_MOCK_REPLACE_WITH_REAL_SECRET_2',
    status: 'active',
    version: 'v2',
    content_type: 'application/json',
    retry_policy: 'linear',
  ...
  },
  {
    ...
    secret: 'whsec_MOCK_REPLACE_WITH_REAL_SECRET_3',
    status: 'active',
    version: 'v2',
    content_type: 'application/json',
    retry_policy: 'exponential',
  ...
  },
  {
    ...
    secret: 'whsec_MOCK_REPLACE_WITH_REAL_SECRET_4',
    status: 'failing',
    version: 'v1',
    content_type: 'application/json',
    retry_policy: 'exponential',
