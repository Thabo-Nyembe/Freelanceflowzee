...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Portal communications GET error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Portal communications POST error:', error)
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Internal server error' },
      { status: 500 }
    )
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Portal communications PUT error:', error)
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Internal server error' },
      { status: 500 }
    )
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Portal communications DELETE error:', error)
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Internal server error' },
      { status: 500 }
    )
