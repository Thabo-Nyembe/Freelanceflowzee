...
// Type definition for activities (used for type inference)
  ...
  const activities = [
    {
      ...
      isRead: false,
      actions: [
        { label: 'View', action: () => { setSelectedActivity(mockActivities[0]); setShowViewDialog(true); } },
        { label: 'Reply', action: () => { setSelectedActivity(mockActivities[0]); setShowReplyDialog(true); } },
      ],
    },
    {
      id: '2',
