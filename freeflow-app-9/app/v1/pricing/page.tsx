          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <nav aria-label="Product links">
              ...
              <ul className="space-y-2" role="list">
                <li><Link href="/v1/features" className="block text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900 rounded px-1">Features</Link></li>
                <li><Link href="/v1/pricing" className="block text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900 rounded px-1">Pricing</Link></li>
            ...
            <nav aria-label="Resource links">
              ...
              <ul className="space-y-2" role="list">
                <li><Link href="/v1/blog" className="block text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900 rounded px-1">Blog</Link></li>
            ...
            <nav aria-label="Company links">
              ...
              <ul className="space-y-2" role="list">
                <li><Link href="/v1/contact" className="block text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900 rounded px-1">Contact</Link></li>
