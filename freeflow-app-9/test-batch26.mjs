...
// Batch 26: More v2 pages (s-z)
const pages = [
  '/dashboard/schedule-v2',
  '/dashboard/search-v2',
  '/dashboard/security-v2',
  '/dashboard/seller-v2',
  '/dashboard/services-v2',
  '/dashboard/shipping-v2',
  '/dashboard/skills-v2',
  '/dashboard/social-v2',
  '/dashboard/statistics-v2',
  '/dashboard/store-v2',
  '/dashboard/workspace-v2',
  '/dashboard/zone-v2',
];

const baseUrl = 'http://localhost:9323';
const screenshotsDir = '/tmp/kazi-batch26';
