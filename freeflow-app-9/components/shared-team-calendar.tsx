          ...
          <Dialog open={state.showCreateEventModal} onOpenChange={() => dispatch({ type: &apos;TOGGLE_CREATE_EVENT_MODAL&apos; })}>
            ...
            <DialogContent className= "max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Schedule a new team event or meeting
                </DialogDescription>
              </DialogHeader>
              <div className= "space-y-4">
                ...
                <div className= "grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select value={newEvent.type} onValueChange={(value: Record<string, unknown>) => setNewEvent({...newEvent, type: value})}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
      ...
      <Dialog open={state.showEventModal} onOpenChange={() => dispatch({ type: &apos;TOGGLE_EVENT_MODAL&apos; })}>
        <DialogContent className= "max-w-md">
          {state.selectedEvent && (
            <>
              <DialogHeader>
                <DialogTitle>{state.selectedEvent.title}</DialogTitle>
                <DialogDescription>
                  {state.selectedEvent.date.toLocaleDateString()} at {state.selectedEvent.time}
                </DialogDescription>
              </DialogHeader>
              <div className= "space-y-4">
                <div className= "flex items-center space-x-2">
