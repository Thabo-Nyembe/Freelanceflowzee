...
export function DynamicSEO({
  title = 'KAZI - Enterprise Freelance Management Platform', description = 'AI-powered creative platform with multi-model studio, universal feedback, real-time collaboration, and secure payments.', keywords = 'KAZI, AI creative platform, freelance management, universal feedback, real-time collaboration', canonical, ogImage = '/kazi-brand/logo-transparent.png', ogType = 'website', structuredData, noIndex = false, alternateUrls = []
}: SEOProps) {
