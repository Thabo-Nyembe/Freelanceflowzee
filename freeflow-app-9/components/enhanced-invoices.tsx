...
import { Search, Plus, Trash2, Edit, Eye, Code, Copy, Palette, X, Download, Send, MoreVertical, Settings, DollarSign, Calendar, Clock, BarChart2, FileText, Layout, Type, Image, Star } from 'lucide-react';
