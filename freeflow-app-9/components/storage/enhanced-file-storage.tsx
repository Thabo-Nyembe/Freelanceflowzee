...
// Context7 useReducer pattern for state management
interface FileStorageState {
  ...
  searchQuery: string
  filterType: 'all' | 'images' | 'videos' | 'documents' | 'audio'
...
interface FileItem {
  ...
  isStarred: boolean
  isShared: boolean
  permissions: 'private' | 'view' | 'edit' | 'public'
...
interface ActivityItem {
  id: string
  action: 'upload' | 'download' | 'share' | 'delete' | 'edit'
  fileName: string
  timestamp: Date
  user: string
}
