...
const pathMapping: Record<string, { title: string; icon?: React.ReactNode }> = {
  ...
  '/dashboard/projects-hub-v2': { title: 'Projects Hub', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/time-tracking-v2': { title: 'Time Tracking', icon: <Clock className="h-4 w-4" /> },
  '/dashboard/analytics-v2': { title: 'Analytics', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/files-hub-v2': { title: 'Files Hub', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/my-day-v2': { title: 'My Day', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/video-studio-v2': { title: 'Video Studio', icon: <Settings className="h-4 w-4" /> },
  ...
  '/dashboard/gallery-v2': { title: 'Gallery Studio', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/ai-create-v2': { title: 'AI Create Studio', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/canvas-v2': { title: 'Canvas Studio', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/booking': { title: 'Booking System', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/ai-assistant-v2': { title: 'AI Assistant', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/notifications-v2': { title: 'Notifications', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/invoices-v2': { title: 'Invoices', icon: <Settings className="h-4 w-4" /> },
  '/dashboard/workflow-builder-v2': { title: 'Workflow Builder', icon: <Settings className="h-4 w-4" /> },
}
