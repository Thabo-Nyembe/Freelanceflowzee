...
// Batch 21: More v1 pages (l-r)
const pages = [
  '/v1/dashboard/learning',
  '/v1/dashboard/legal',
  '/v1/dashboard/listings',
  '/v1/dashboard/logistics',
  '/v1/dashboard/loyalty',
  '/v1/dashboard/marketplace',
  '/v1/dashboard/meetings',
  '/v1/dashboard/milestones',
  '/v1/dashboard/networking',
  '/v1/dashboard/orders',
  '/v1/dashboard/pipeline',
  '/v1/dashboard/preview',
  '/v1/dashboard/referrals',
];

const baseUrl = 'http://localhost:9323';
const screenshotsDir = '/tmp/kazi-batch21';
