...
test.describe('Complete Page Audit - All Routes Since Inception', () => {
  ...
  const featurePages = [
    ...
    { path: '/dashboard/collaboration-v2', name: 'Collaboration', expectedText: ['Collaboration'] },
    ...
    { path: '/dashboard/profile-v2', name: 'CV Portfolio', expectedText: ['Portfolio', 'CV'] },
    { path: '/dashboard/gallery-v2', name: 'Gallery', expectedText: ['Gallery'] },
    { path: '/dashboard/bookings-v2', name: 'Bookings', expectedText: ['Bookings'] },
    { path: '/dashboard/calendar-v2', name: 'Calendar', expectedText: ['Calendar'] },
    { path: '/dashboard/my-day-v2', name: 'My Day', expectedText: ['My Day'] },
    { path: '/dashboard/financial-hub', name: 'Financial Hub', expectedText: ['Financial'] },
    { path: '/dashboard/escrow-v2', name: 'Escrow', expectedText: ['Escrow'] },
